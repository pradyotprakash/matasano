...
def lengthExtend(hash_, newtext):
	padded = _pad(newtext)

	x = MD4('')
	x.A = int(hash_[0:8], 16)
	x.B = int(hash_[8:16], 16)
	x.C = int(hash_[16:24], 16)
	x.D = int(hash_[24:32], 16)
...
if __name__ == '__main__':
	print lengthExtend(MD4('').digest(), 'hello')
